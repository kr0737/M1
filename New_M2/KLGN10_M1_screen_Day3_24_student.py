...
def function3(): #final results
    ...
    #end
    stop_animation()
    messagebox.showinfo("3. Examine Results", "Did you find the linear region and have enough experimental units to do linear regression?")
...
button3 = tk.Button(frame, text="3. End Analysis", padx=20, pady=10, command=function3, font=("Helvetica", 10), fg="white", bg="#c37c4d", relief="raised")
